...
class ConfusionMatrix:
    ...
    def plot(self, normalize=True, save_dir="", names=(), on_plot=None):
        ...
        ax.set_xlabel("True", fontsize=14)  # Increased font size for X-axis label
        ax.set_ylabel("Predicted", fontsize=14)  # Increased font size for Y-axis label
        ax.set_title(title, fontsize=16)  # Increased font size for title
